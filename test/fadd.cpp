...
// extern "C" __declspec(dllexport) svBitVecVal faddc(int a1,int a2){
int faddc(int a1,int a2){
   //  long long int a1,a2;
   //  scanf("%lld",&&a1);
   //  scanf("%lld",&&a2);
    wire x1 = init(32,a1);
...
//                         //    }
//                      }
//                      faddc(concat(concat(init(1,s1),init(8,i)),m1),concat(concat(init(1,s2),init(8,j)),m2));
//                   }
//                }
//             }
//          }
